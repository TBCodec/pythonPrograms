...
while gyakorlas:
    ...
    while szemely != 't' and szemely != 'b' and szemely != 'g' and szemely != 'l' and szemely != 'nb':
        ...
        if szemely == 'b':
            ...
            hibagyujto = 'D:\\Nagy meghajtó\Programozás\Python\szókikérdező\hibák_Bazsi.txt'
        elif szemely == 't':
            eltSzav = "eltalaltSzavak_Tomi.txt"
            statik = "Statisztika_Tomi.txt"
            hibagyujto = 'D:\\Nagy meghajtó\Programozás\Python\szókikérdező\hibák_Tomi.txt'
        elif szemely == 'g':
            eltSzav = "eltalaltSzavak_Gabi.txt"
            statik = "Statisztika_Gabi.txt"
            hibagyujto = 'D:\\Nagy meghajtó\Programozás\Python\szókikérdező\hibák_Gabi.txt'
        elif szemely == 'l':
            eltSzav = "eltalaltSzavak_Livia.txt"
            statik = "Statisztika_Livia.txt"
            hibagyujto = 'D:\\Nagy meghajtó\Programozás\Python\szókikérdező\hibák_Livia.txt'
        elif szemely == 'nb':
            eltSzav = "eltalaltSzavak_NBalazs.txt"
            statik = "Statisztika_NBalazs.txt"
            hibagyujto = 'D:\\Nagy meghajtó\Programozás\Python\szókikérdező\hibák_NBalazs.txt'
        else:
            print('Nem jó gombot nyomtál!!!')
